 ...
 *
 */
interface Call2ActionSliceDefaultPrimary {
  /**
   * Title field in *Call2Action → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: call2_action.primary.title
   * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
   *
   */
  title: prismic.TitleField;
  /**
   * Tagline field in *Call2Action → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: call2_action.primary.tagline
   * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
   *
   */
  tagline: prismic.RichTextField;
  /**
   * Button field in *Call2Action → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: call2_action.primary.button
   * - **Documentation**: https://prismic.io/docs/core-concepts/link-content-relationship
   *
   */
  button: prismic.LinkField;
  /**
   * Background field in *Call2Action → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: call2_action.primary.background
...
/**
 * Default variation for Call2Action Slice
 *
 * - **API ID**: `default`
 * - **Description**: `Default`
 ...
 *
 */
export type Call2ActionSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<Call2ActionSliceDefaultPrimary>,
  never
>;
/**
 * Slice variation for *Call2Action*
 *
 */
type Call2ActionSliceVariation = Call2ActionSliceDefault;
/**
 * Call2Action Shared Slice
 *
 * - **API ID**: `call2_action`
 * - **Description**: `Call2Action`
 * - **Documentation**: https://prismic.io/docs/core-concepts/reusing-slices
 *
 */
export type Call2ActionSlice = prismic.SharedSlice<
  "call2_action",
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      SettingsDocument,
      AllDocumentTypes,
      Call2ActionSliceDefaultPrimary,
      Call2ActionSliceDefault,
      Call2ActionSliceVariation,
      Call2ActionSlice,
